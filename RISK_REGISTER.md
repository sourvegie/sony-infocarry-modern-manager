...
eligibility remains unproven. P17-001 device-aware Library planning is now
complete for its offline-only queue/review scope; no device transfer is enabled.
The current portable suite is **559 tests** with three
