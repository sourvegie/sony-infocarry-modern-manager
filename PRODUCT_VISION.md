...
authoring and no device candidate. I.9 and I.10 address mixed TXT/BMP and a
representative small ebook package offline first. H.2 deletion generalization remains a separate fail-closed
