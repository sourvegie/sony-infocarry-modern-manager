...
current portable suite is **417 tests** with three
...
The I.7 controlled legacy add protocol and read-only support tooling are
prepared, but no add approval or hardware operation is included in this
checkpoint; the later deletion stage remains separately gated.
