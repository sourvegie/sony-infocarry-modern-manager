...
planning remains deferred. The current portable suite is **524 tests** with three
...
isolated, one-shot, approval-gated live adapter; it is host-tested and
R3-reviewed at `READY_FOR_HARDWARE_TEST`, with no hardware transaction
performed.
