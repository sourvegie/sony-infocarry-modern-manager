...
current portable suite is **433 tests** with three
...
4. Keep H.2 deletion generalization blocked and parked pending independent
   ...
   A separate I7 legacy-delete session protocol and fail-closed preflight are
   prepared for the stateful disposable target, but remain unexecuted and do
   not authorize a device mutation or modern delete.
