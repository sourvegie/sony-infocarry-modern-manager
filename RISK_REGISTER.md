...
and PR #2 is merged at `02dc39e`; P15-003 follow-up documentation is on its
task branch pending review/merge.
...
planning remains deferred. The current portable suite is **525 tests** with three
